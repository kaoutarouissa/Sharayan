...
export default function Hero() {
  ...
  return (
    <section className="relative w-full min-h-[85vh] overflow-hidden text-white flex items-center">
      <video
        autoPlay
        loop
        muted
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-16 py-16 w-full flex flex-col justify-between h-full min-h-[70vh]">
        ...
        <div className="max-w-2xl space-y-6 mt-8">
          ...
          <p className="text-gray-200 text-sm md:text-base leading-relaxed font-light">
            Un geste simple de 45 minutes qui transforme le destin direct d'un
            patient en réanimation, d'une jeune maman en maternité ou d'une
            personne en cancérologie. 1 seul don permet de sauver jusqu'à{" "}
            <span className="font-bold text-white">3 vies</span>.
          </p>

          {/* Boutons d'action */}
          <div className="flex flex-wrap gap-4 pt-4">
            <button
              onClick={handelDonnerSang}
              className="bg-[#B31919] hover:bg-[#8B1212] text-white font-semibold px-6 py-3.5 rounded-xl flex items-center gap-2 transition duration-200 shadow-lg"
            >
        ...
        <div className="self-end mt-12 md:mt-0 max-w-sm">
          ...
          <p className="text-sm font-medium italic text-gray-200 leading-snug">
            « Chaque jour, des milliers d'anonymes offrent le plus beau des
            dons. »
          </p>
        </div>
      </div>
