...
export default function AdminDashboard() {
  return (
    <div className="min-h-screen flex flex-col bg-slate-50">
      ...
      <main className="flex-1 p-6 md:p-10 text-slate-800 space-y-8 font-sans">
              ...
              <tbody className="divide-y divide-slate-100 text-slate-700">
                ...
                <tr>
                  ...
                  <td className="py-3.5">
                    12/09/2026
                    <br />
                    <span className="text-slate-400">10h</span>
                  </td>
                ...
                <tr>
                  ...
                  <td className="py-3.5">
                    13/09/2026
                    <br />
                    <span className="text-slate-400">14h</span>
                  </td>
                ...
                <tr>
                  ...
                  <td className="py-3.5">
                    14/09/2026
                    <br />
                    <span className="text-slate-400">09h</span>
                  </td>
